...
public class Campaign1 {
	...
	public static void main(String[] args) throws InterruptedException {
	    ...
	    driver.findElement(By.id("Campaigns_editView_fieldName_campaignname")).sendKeys("Digvijay");
	    driver.findElement(By.id("s2id_autogen1")).click();
	    WebElement ele1 = driver.findElement(By.id("s2id_autogen2_search"));
	    ele1.sendKeys("Team Selling");
	...
	//    driver.findElement(By.id("product_id_display")).sendKeys("ABCD");
	    ...
	    driver.findElement(By.id("Products_editView_fieldName_productname")).sendKeys("EarPhones");
	    driver.findElement(By.id("Products-editview-fieldname-unit_price")).sendKeys("1200");
	    ...
	    Thread.sleep(2000);
	    driver.findElement(By.id("s2id_autogen104")).click();
	    WebElement product = driver.findElement(By.id("s2id_autogen105_search"));
	    product.sendKeys("Team Selling");
		...
		driver.findElement(By.id("Campaigns_editView_fieldName_sponsor")).sendKeys("Digvijay Swami");
