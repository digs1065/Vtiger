...
public class Organization {
	public static void main(String[] args) throws InterruptedException {
	    ...
	    driver.findElement(By.id("Accounts_editView_fieldName_accountname")).sendKeys("Digvijay");
	    ...
	    Thread.sleep(2000);
	    driver.findElement(By.xpath("(//input[@id='Accounts_editView_fieldName_accountname'])[2]")).sendKeys("SIDI");
	    driver.findElement(By.xpath("(//input[@id='Accounts_editView_fieldName_website'])[2]")).sendKeys("www.asjak.coooom");
	    driver.findElement(By.xpath("(//input[@id='Accounts_editView_fieldName_phone'])[2]")).sendKeys("8589965585");
	    
	    driver.findElement(By.id("s2id_autogen11")).click();
	    WebElement framedp = driver.findElement(By.id("s2id_autogen12_search"));
	 ...
	 //   driver.findElement(By.id("account_id_display")).sendKeys("ABCD");
	    ...
	    driver.findElement(By.id("Accounts_editView_fieldName_email1")).sendKeys("digvijay1065@gmail.com");
	    driver.findElement(By.id("Accounts_editView_fieldName_email2")).sendKeys("digvijay1065@gmail.com");
