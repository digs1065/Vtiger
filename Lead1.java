...
public class Lead1 {
	public static void main(String[] args) throws InterruptedException, IOException {
	    ...
	    driver.findElement(By.id("Leads_editView_fieldName_firstname")).sendKeys("Digvijay");
	    driver.findElement(By.id("Leads_editView_fieldName_lastname")).sendKeys("Swami");
	    driver.findElement(By.id("Leads_editView_fieldName_phone")).sendKeys("9922471065");
	    driver.findElement(By.id("Leads_editView_fieldName_company")).sendKeys("DS Softwares");
	    driver.findElement(By.id("Leads_editView_fieldName_mobile")).sendKeys("9922471065");
	    ...
	    driver.findElement(By.id("Leads_editView_fieldName_email")).sendKeys("digvijay1065@yahoo.com");
	    ...
	    driver.findElement(By.id("Leads_editView_fieldName_secondaryemail")).sendKeys("swamidigvijay@yahoo.com");
	    ...
	    Thread.sleep(1000);
	    driver.findElement(By.id("Leads_editView_fieldName_lane")).sendKeys("Dhayari DSK");
	    driver.findElement(By.id("Leads_editView_fieldName_pobox")).sendKeys("Dhayari post");
	    ...
	    Thread.sleep(2000);
	    Runtime.getRuntime().exec("C:\\Users\\Digvijay\\Desktop\\Autoit\\popup.exe");
